...
| **アクティビティタイプ** | [**DiscordRPCアクティビティタイプ**](#discordrpcアクティビティタイプ) | ◎ | アクティビティの種類 (○○○を「プレイ中」の部分) |
...
| **メッセージタイプ** | [DiscordRPCメッセージタイプ](#discordrpcメッセージタイプ) | □ | 受信したメッセージの種類 |
...
### [Discord Rich Presence (discord-rpc-csharp)](https://github.com/Lachee/discord-rpc-csharp)

[MIT License](https://github.com/Lachee/discord-rpc-csharp/blob/master/LICENSE)
